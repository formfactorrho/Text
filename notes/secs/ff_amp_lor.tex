...
%
{\mh [Can we still use the following text?: three-independent form factors to determine, the charge, magnetic and quadrupole form factors. These are proportional to the the charge, magnetic moment, and quadrupole moment of the $\rho^+$. Furthermore, one can obtain the correspond radii of the $\rho^+$.]} 
%
...
{\mh To better understand the problems we are having with $T$, we now consider the action of $P$ on the $\rho$ state
\begin{equation}
